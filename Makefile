...
C_OBJS = client_main.o sample_util.o tizen_device.o

C_SRCS = client_main.c sample_util.c tizen_device.c

SRCS = $(S_SRCS) $(C_SRCS)

CC = gcc
INCS = -I$(PWD)/../upnp/include
LIBRARY_DIR = $(PWD)/../upnp/lib
LIBRARIES = -lupnp -lthreadutil -lpthread -lixml
CFLAGS = -g -c $(INCS) -DTIZEN 
...
$(CLIENT) : $(C_OBJS)
	$(CC) -o $(CLIENT) $(C_OBJS) -L$(LIBRARY_DIR) $(LIBRARIES)
